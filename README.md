...
Covers KPIs, sales trends by day and month, category and size breakdown, top and bottom performing pizzas.
...
Covers customer segmentation, revenue by demographics, product performance, discount impact, and subscription behaviour.
...
Covers sales KPIs, monthly and daily trends, quarterly performance, top cities, and Veg vs Non-Veg breakdown.
...
Охоплює KPI, динаміку продажів за днями та місяцями, структуру за категоріями та розмірами, рейтинг найпопулярніших і найменш популярних позицій.
...
Охоплює сегментацію клієнтів, виручку за демографією, ефективність товарів, вплив знижок та поведінку підписників.
...
Охоплює KPI продажів, місячні та денні тренди, квартальну динаміку, топ-міста та розподіл між веганською і невеганською їжею.
